...
def render():
    ...
    # The max number of harmonics is bounded by the number of points we sample (we'll sample 300 points)
        ...
        <script>
          ...
          function draw() {{
            ...
            for (let i = 0; i < path.length; i++) {{
               ...
               strokeWeight(4.5);
               // Fade slowly into a faint glow instead of going completely invisible
               stroke(0, 255, 255, map(i, 0, path.length, 255, 30));
